      ...
      <div className="form-group form-inline" style={{ paddingTop: 30 }}>
        <div className="row">
          <div className="col-sm-10">
            <input onKeyDown={this.onKeyDownHandler} type="text" className="form-control form-control-lg" style={{ width: "100%" }} placeholder="Your message" onChange={this.handleChange} value={this.state.input} />
          </div>
